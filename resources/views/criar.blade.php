              ...
              <div class="pe-lg-5">
                ...
                <nav class="d-none d-md-block">
                    <ul class="list-unstyled d-flex justify-content-start mt-4 align-items-center fw-bolder small">
                      ...
                      <li class="me-4"><a class="nav-link-checkout ">Criar Tarefa</a></li>
                    </ul>
                </nav>                        
                      
                <div class="mt-5">
                  <h3 class="fs-5 mt-5 fw-bolder mb-4 border-bottom pb-4">Criar</h3>
                  <div class="row">

                    <!-- Nome da tarefa-->
                    <div class="col-12">
                      <form action="{{route('Cadastro-tarefa')}}" method="post">
                        @csrf
                         <div class="form-group">
                          <label for="nm_tarefa" class="form-label">Nome da tarefa</label>
                          <input type="text" class="form-control" name="nm_tarefa" id="nm_tarefa"  required="">
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="conteudo_tarefa" class="form-control" id="Descrição"  required="">
                        </div>
                      </div>
